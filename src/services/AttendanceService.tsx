...
export class AttendanceService extends BaseService {
    ...
    static getList(params?: { date?: any; search?: string; page?: number; status?: PATIENT_STATUS | '' }): Promise<ResponseModel<PageModel<PatientModel>>> {
        ...
        return new Promise((resolve, reject) => {
            this.Http.get(this.API_PREFIX + '/patients', {
                params: {
                    date: params?.date,
    ...
    static postAttendance(params = {}): Promise<ResponseModel<any>> {
        return new Promise((resolve, reject) => {
            this.Http.post(this.API_PREFIX + '/bulk', params)
                .then((res) => resolve(res?.data))
                .catch((err) => reject(err));
        });
    }
    ...
    static markAttendance(params = {}): Promise<ResponseModel<any>> {
        return new Promise((resolve, reject) => {
            this.Http.post(this.API_PREFIX + '/single', params)
                .then((res) => resolve(res?.data))
                .catch((err) => reject(err));
        });
    }
